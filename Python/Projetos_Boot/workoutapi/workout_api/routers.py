...
from workout_api.centrotreinamento.controller import router as centrotreinamento

api_router = APIRouter()
api_router.include_router(atleta, prefix='/atletas', tags=['atletas'])
api_router.include_router(categorias, prefix='/categorias', tags=['categorias'])
api_router.include_router(centrotreinamento, prefix='/centrotreinamento', tags=['centros_treinamento'])